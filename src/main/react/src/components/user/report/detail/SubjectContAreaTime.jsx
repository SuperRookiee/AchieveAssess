...
const SubjectContAreaTime = ({ currentExamInfo, detailAllErratum, detailOneErratum }) => {
    ...
    const calculateAverage = (detailErratum, contentArea) => {
        ...
        const totalDuration = subAbil.reduce((total, item) => total + item.duration, 0);
        return subAbilCnt ? Math.floor(totalDuration / subAbilCnt) : 0;
    };
...
export default SubjectContAreaTime;